...
<body>
	...
	<div class="mid_title">资产构成风险比较</div>
	<div class="mid_kong"></div>
	<form action="GetIndustryReportstatistics04" method="post">
...
<table class="mid_table">
	  <tbody>
	    <tr>
		  ...
		  <th scope="col" class="mid_table_title">存货</th>
		  <th scope="col" class="mid_table_title">存货/总资产</th>
		  <th scope="col" class="mid_table_title">存货增长率</th>
		  <th scope="col" class="mid_table_title">固产合计/总资产</th>
	      <th scope="col" class="mid_table_title">投资类资产占总资产</th>
		  <th scope="col" class="mid_table_title">商誉/总资产</th>
		  <th scope="col" class="mid_table_title">无形资产/总资产</th>
		  <th scope="col" class="mid_table_title">其他应收款/总资产</th>
	    ...
	    <tr>
	      ...
	      <td class="mid_table_content">${rsf.inventoryFormated}</td>
	      <td class="mid_table_content">${rsf.inventoryToRevenueRatioFormated}</td>
		<td class="mid_table_content">${rsf.inventoryGrowthRateFormated}</td>
		<td class="mid_table_content">${rsf.fixedAssetRatioFormated}</td>
		<td class="mid_table_content">${rsf.investmentAssetRatioFormated}</td>
		<td class="mid_table_content">${rsf.goodwillProportionFormated}</td>
		<td class="mid_table_content">${rsf.theProportionOfIntangibleAssetsFormated}</td>
		<td class="mid_table_content">${rsf.otherReceivablesPercentageOfRevenueFormated}</td>
		<td class="mid_table_content">
		<a href="GetProportionOfOtherAssetsForYears?AShareCode=${rsf.AShareCode}&AShareName=${rsf.AShareName}" target="_blank">查看</a>
		</td>
        </tr>
	 </c:forEach>
      </tbody>
