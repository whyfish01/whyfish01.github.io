...
<body>
	...
	<div class="mid_title">行业上下游竞争力比较</div>
	<div class="mid_kong"></div>
	<form action="GetIndustryReportstatistics03" method="post">
...
<table class="mid_table">
	  <tbody>
	    <tr>
	      ...
	      <th scope="col" class="mid_table_title">应付预收合计</th>
	      <th scope="col" class="mid_table_title">应收预付合计</th>
	      <th scope="col" class="mid_table_title">应付预收-应收预付</th>
		  <th scope="col" class="mid_table_title">合同负债</th>
		  <th scope="col" class="mid_table_title">应收账款/总资产</th>
		  <th scope="col" class="mid_table_title">预付款项/总资产</th>
	    ...
	    <tr>
	      ...
	      <td class="mid_table_content">${rsf.totalAccountsReceivablePrepaymentsFormated}</td>
	      <td class="mid_table_content">${rsf.occupySomeoneElseFundsFormated}</td>
		<td class="mid_table_content">${rsf.contractLiabilitiesFormated}</td>
		<td class="mid_table_content">${rsf.accountsReceivablePercentageOfRevenueFormated}</td>
		<td class="mid_table_content">${rsf.prepaymentsPercentageOfRevenueFormated}</td>
		<td class="mid_table_content">
		<a href="GetOccupySomeoneElseFundsForYears?AShareCode=${rsf.AShareCode}&AShareName=${rsf.AShareName}" target="_blank">查看</a>
		</td>
        </tr>
	 </c:forEach>
      </tbody>
