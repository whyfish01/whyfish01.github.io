...
<body>
	...
	<td>
	<div class="mid_title">新建企业信息</div>
	<div class="mid_kong"></div>
	<form action="InsertCompany" method="post">
			
	<div class="mid_div">
		<div class="mid_div01_red">企业全称：</div>
		<div class="mid_div02"><input type="text" class="mid_box01" name="companyName"></div>
	...
	<div class="mid_div">
		...
		<div class="mid_div02"><input type="text" class="mid_box01" name="companyAddress"></div>
		...
		<div class="mid_div03"><input type="text" class="mid_box02" name="establishedDate"></div>
	</div>
	<div class="mid_div">
	...
	<div class="mid_div">
		...
		<div class="mid_div04"><input type="text" class="mid_box02" name="listingDate"></div>
		<div class="mid_div01">注册资本：</div>
		<div class="mid_div04"><input type="text" class="mid_box02" name="registeredCapital"></div>
	</div>
	<div class="mid_div">
		<div class="mid_div01">经营范围：</div>
		<div class="mid_div05a"><textarea class="mid_box04c"  name="businessScope"></textarea></div>
		<div class="mid_div01">法定代表：</div>
		<div class="mid_div03"><input type="text" class="mid_box02"  name="legalRepresentative"></div>
	</div>
	<div class="mid_div">
