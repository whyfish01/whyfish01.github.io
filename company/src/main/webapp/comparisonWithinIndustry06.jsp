...
<body>
	...
	<div class="mid_title">费用率比较</div>
	<div class="mid_kong"></div>
	<form action="GetIndustryReportstatistics06" method="post">
...
<table class="mid_table">
	  <tbody>
	    <tr>
	      ...
	      <th scope="col" class="mid_table_title">四项费用合计</th>
	      <th scope="col" class="mid_table_title">销售费用率</th>
		  <th scope="col" class="mid_table_title">管理费用率</th>
		  <th scope="col" class="mid_table_title">研发费用率</th>
		  <th scope="col" class="mid_table_title">费用率</th>
		  <th scope="col" class="mid_table_title">费用率占毛利率的比率</th>
	    ...
	    <tr>
	      ...
	      <td class="mid_table_content">${rsf.salesExpenseRateFormated}</td>
	      <td class="mid_table_content">${rsf.managementExpenseRateFormated}</td>
		<td class="mid_table_content">${rsf.researchAndDevelopmentRateFormated}</td>
		<td class="mid_table_content">${rsf.expenseFormated}</td>
		<td class="mid_table_content">${rsf.expenseRateToGrossProfitMarginFormated}</td>
		<td class="mid_table_content">
		<a href="GetExpenseForYears?AShareCode=${rsf.AShareCode}&AShareName=${rsf.AShareName}" target="_blank">查看</a>
		</td>
        </tr>
	 </c:forEach>
      </tbody>
