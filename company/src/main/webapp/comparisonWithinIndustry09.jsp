...
<body>
	...
	<div class="mid_title">现金流量比较</div>
	<div class="mid_kong"></div>
	<form action="GetIndustryReportstatistics09" method="post">
...
<table class="mid_table">
	  <tbody>
	    <tr>
	      ...
	      <th scope="col" class="mid_table_title">经营活动产生的现金流量</th>
	      <th scope="col" class="mid_table_title">经营活动产生的现金流量增长率</th>
		  <th scope="col" class="mid_table_title">公司类型</th>
		  <th scope="col" class="mid_table_title">现金及现金等价物净增加额</th>
		  <th scope="col" class="mid_table_title">加分红的现金及现金等价物净增加额</th>
		  <th scope="col" class="mid_table_title">期末现金及现金等价物余额</th>
		  <th scope="col" class="mid_table_title">购建固产占经营活动产生的现金比率</th>
		  <th scope="col" class="mid_table_title">处置固定无形和其他长期资产收回现金占购置比率</th>
	    ...
	    <tr>
	      ...
	      <td class="mid_table_content">${rsf.growthRateOfNetCashFlowFromOperatingFormated}</td>
		<td class="mid_table_content">${rsf.companyType}</td>
		<td class="mid_table_content">${rsf.netIncreaseInCashAndCashEquivalentsFormated}</td>
		<td class="mid_table_content">${rsf.netIncreaseInCashAndCashEquivalentsAddBonusFormated}</td>
		<td class="mid_table_content">${rsf.closingBalanceOfCashAndCashEquivalentsFormated}</td>
		<td class="mid_table_content">${rsf.purchaseConstructionFixedIntangibleLongTermAssetsProportionFormated}</td>
		<td class="mid_table_content">${rsf.netCashReceivedFromDisposalProportionTopurchaseFormated}</td>
		<td class="mid_table_content">
		<a href="GetcashPaidAndReceivedForYears?AShareCode=${rsf.AShareCode}&AShareName=${rsf.AShareName}" target="_blank">查看</a>
		</td>
        </tr>
	 </c:forEach>
      </tbody>
