...
<body>
	...
	<div class="mid_title">准货币资金实力比较</div>
	<div class="mid_kong"></div>
	<form action="GetIndustryReportstatistics02" method="post">
...
<table class="mid_table">
	  <tbody>
	    <tr>
	      ...
	      <th scope="col" class="mid_table_title">货币资金</th>
	      <th scope="col" class="mid_table_title">准货币资金</th>
	      <th scope="col" class="mid_table_title">准货币资金/总资产</th>
		  <th scope="col" class="mid_table_title">短期有息负债</th>
		  <th scope="col" class="mid_table_title">准货币资金-短期有息负债</th>
		  <th scope="col" class="mid_table_title">有息负债</th>
		  <th scope="col" class="mid_table_title">净现金</th>
	    ...
	    <tr>
	      ...
	      <td class="mid_table_content">${rsf.quasiMonetaryFormated}</td>
	      <td class="mid_table_content">${rsf.quasiMonetaryCapitalRatioFormated}</td>
		<td class="mid_table_content">${rsf.shortTermForeignDebtFormated}</td>
		<td class="mid_table_content">${rsf.shortTermDebtRepaymentRiskFormated}</td>
		<td class="mid_table_content">${rsf.interestBearingLiabilitiesFormated}</td>
		<td class="mid_table_content">${rsf.debtRepaymentRiskFormated}</td>
		<td class="mid_table_content">
		<a href="GetDebtRepaymentRiskForYears?AShareCode=${rsf.AShareCode}&AShareName=${rsf.AShareName}" target="_blank">查看</a>
		</td>
        </tr>
	 </c:forEach>
      </tbody>
