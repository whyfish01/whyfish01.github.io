...
<body>
	...
	<div class="mid_title">归母净利润与分红比较</div>
	<div class="mid_kong"></div>
	<form action="GetIndustryReportstatistics08" method="post">
...
<table class="mid_table">
	  <tbody>
	    <tr>
	      ...
	      <th scope="col" class="mid_table_title">归属于母公司所有者的净利润</th>
	    ...
	    <tr>
	      ...
	      <td class="mid_table_content">${rsf.growthRateOfNetIncomeAttributableToShareholdersFormated}</td>
	      <td class="mid_table_content">${rsf.financialReportDividendsFormated}</td>
		<td class="mid_table_content">${rsf.dividendRateFormated}</td>
		<td class="mid_table_content">
		<a href="GetDividendRateForYears?AShareCode=${rsf.AShareCode}&AShareName=${rsf.AShareName}" target="_blank">查看</a>
		</td>
        </tr>
	 </c:forEach>
      </tbody>
