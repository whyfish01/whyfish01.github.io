...
<body>
	...
	<div class="mid_title">总资产及负债情况比较</div>
	<div class="mid_kong"></div>
	<form action="GetIndustryReportstatistics01" method="post">
...
<table class="mid_table">
	  <tbody>
	    <tr>
	      ...
	      <th scope="col" class="mid_table_title">净资产</th>
		  <th scope="col" class="mid_table_title">权益乘数</th>
		  <th scope="col" class="mid_table_title">总负债</th>
	    ...
	    <tr>
	      ...
	      <td class="mid_table_content">${rsf.totalOwnersEquityFormated}</td>
		<td class="mid_table_content">${rsf.equityMultiplierFormated}</td>
		<td class="mid_table_content">${rsf.totalLiabilitiesFormated}</td>
		<td class="mid_table_content">${rsf.assetLiabilityRatioFormated}</td>
		<td class="mid_table_content">
		<a href="GetTotalAssetsForYears?AShareCode=${rsf.AShareCode}&AShareName=${rsf.AShareName}" target="_blank">查看</a>
		</td>
        </tr>
	 </c:forEach>
      </tbody>
