...
public class InsertCashflowStatement extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	boolean insertResult=rdi.insertCashflowStatement(cs);
    	...
    	RequestDispatcher dispatcher=request.getRequestDispatcher("financialReportAdd2.jsp");
