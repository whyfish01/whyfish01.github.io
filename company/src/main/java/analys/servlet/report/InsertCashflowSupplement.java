...
public class InsertCashflowSupplement extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	String convertibleCorporatebondsDueWithinOneYear_str = request.getParameter("conversionOfDebtIntoCapital");
    	...
    	boolean insertResult=rdi.insertCashflowSupplement(cfs);
    	if(insertResult) {
            // 添加成功，设置成功消息
    	...
    	RequestDispatcher dispatcher=request.getRequestDispatcher("financialReportAdd3.jsp");
