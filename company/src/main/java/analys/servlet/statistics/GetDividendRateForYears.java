...
public class GetDividendRateForYears extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	List<ReportAnalysis> anList= aadi.getReportAnalysisForCompany18(AShareCode);
    	...
    	RequestDispatcher dispatcher=request.getRequestDispatcher("financialReportAnalysis18.jsp");
