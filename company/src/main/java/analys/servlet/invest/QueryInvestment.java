...
public class QueryInvestment extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	List<InvestmentFormated> ifList= ddi.QueryInvestment(AShareCode, AShareName, reportingYear);
    	...
    	//计算总记录数
    	totalCounts = ddi.getInvestmentCount(AShareCode, AShareName, reportingYear);
    	...
    	//返回页面
    	RequestDispatcher dispatcher=request.getRequestDispatcher("investmentAdmin.jsp?page=pageIndex");
