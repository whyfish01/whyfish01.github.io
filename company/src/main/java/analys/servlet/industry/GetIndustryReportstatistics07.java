...
public class GetIndustryReportstatistics07 extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(industry1IsNull) {
        	...
        	List<ReportSummaryFormated> rsfList = iadi.getIndustryReportstatistics07(industry1, industry2, industry3, financialReportingYear);
        	request.setAttribute("rsfList", rsfList);
        }
    	
    	RequestDispatcher dispatcher=request.getRequestDispatcher("comparisonWithinIndustry07.jsp");
