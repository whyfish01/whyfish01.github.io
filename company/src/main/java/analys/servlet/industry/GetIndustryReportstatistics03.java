...
public class GetIndustryReportstatistics03 extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(industry1IsNull) {
        	...
        	List<ReportSummaryFormated> rsfList = iadi.getIndustryReportstatistics03(industry1, industry2, industry3, financialReportingYear);
        	request.setAttribute("rsfList", rsfList);
        }
    	
    	RequestDispatcher dispatcher=request.getRequestDispatcher("comparisonWithinIndustry03.jsp");
